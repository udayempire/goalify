            ...
            <div className="container mx-auto">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden lg:block">
                        <Link href="#" className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-full transition-colors duration-300">
                            Get Started
                        </Link>
                    </div>
                ...
                {isOpen && (
                    <div className="lg:hidden mt-4 transition-all duration-300" id="mobile-menu">
                        <div className="flex flex-col space-y-4">
                            ...
                            <Link href="#" className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-full text-center transition-colors duration-300">
                                Get Started
                            </Link>
                        </div>
                    </div>
